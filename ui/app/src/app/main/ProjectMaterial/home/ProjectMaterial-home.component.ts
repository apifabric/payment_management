...
@Component({
  selector: 'ProjectMaterial-home',
  templateUrl: './ProjectMaterial-home.component.html',
  styleUrls: ['./ProjectMaterial-home.component.scss']
})
export class ProjectMaterialHomeComponent implements AfterViewInit {
