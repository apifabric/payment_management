...
@Component({
  selector: 'ProjectEmployee-home',
  templateUrl: './ProjectEmployee-home.component.html',
  styleUrls: ['./ProjectEmployee-home.component.scss']
})
export class ProjectEmployeeHomeComponent implements AfterViewInit {
