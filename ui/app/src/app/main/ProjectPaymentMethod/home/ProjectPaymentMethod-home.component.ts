...
@Component({
  selector: 'ProjectPaymentMethod-home',
  templateUrl: './ProjectPaymentMethod-home.component.html',
  styleUrls: ['./ProjectPaymentMethod-home.component.scss']
})
export class ProjectPaymentMethodHomeComponent implements AfterViewInit {
